...
%token IDENTIFIER STRING_LITERAL LITERAL_TRUE LITERAL_FALSE NUMBER_LITERAL
%token TYPE_AGGREGATE TYPE_STRING TYPE_NUMBER TYPE_BOOL
%token TYPE MONITOR GIVEN WHEN THEN ALL ANY EXCEPT SHOW
